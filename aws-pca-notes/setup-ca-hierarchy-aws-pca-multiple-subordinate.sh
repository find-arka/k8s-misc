...
# Purpose:
# Creates one Root CA and 2 Subordinate CAs in AWS Private Certificate Authority(PCA).
# - One Subordinate CA is meant to be used to setup the CA for the Gloo Mesh Server and Gloo Mesh Agents.
# - Another Subordinate CA is meant to be used to setup the CA for Istio.
...
# Replace "Gloo-Mesh" "Istio" in the for loop below with keyword "Common" if 
# you need the same common Subordinate CA for Gloo Mesh and for Istio.
##
for CA_FOR_COMPONENT in "Gloo-Mesh" "Istio"
do
    echo
    echo "###########################################################"
